...
public:
    ...
    Sophus::SE3f TrackRGBDWithMask(const cv::Mat &im, const cv::Mat &depthmap, const cv::Mat &semanticmask, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
